        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <a href="{{ url('admin/tambahJenis') }}" class="btn btn-secondary"
                        ...
                        <tbody>
                            @foreach ($jeniskamar as $item)
                                <tr class="text-center">
                                    ...
                                    <td style="vertical-align: middle">{{ $item->jeniskamar }}</td>
                                    <td style="vertical-align: middle">
                                        <div class="d-flex justify-content-center">
                                            <a href="/admin/jenis/edit/{{ $item->id }}" class="btn px-2"><img
