            ...
            add(t) {
              ...
              this.dt.hiddenHeader ? (s.innerHTML = "") : t.heading.nodeName ? s.appendChild(t.heading) : (s.innerHTML = t.heading),
                ...
                this.dt.data.forEach((s, a) => {
                  t.data[a] &&
                    ((e = document.createElement("td")), t.data[a].nodeName ? e.appendChild(t.data[a]) : (e.innerHTML = t.data[a]), (e.data = e.innerHTML), t.render && (e.innerHTML = t.render.call(this, e.data, e, s)), s.appendChild(e));
                }),
